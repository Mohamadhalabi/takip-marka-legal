                                    ...
                                    <tr>
                                        <td class="content-cell"
                                            ...
                                            <h1
                                                ...
                                                {{ __('theme/emails/welcome-email.welcome') }}</h1>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.7em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/welcome-email.hello') }} {{ $name['data'] }},</p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.7em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/welcome-email.first-paragraph') }}</p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.7em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/welcome-email.second-paragraph') }}</p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.7em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/welcome-email.thanks-text') }}
                                            </p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.7em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/welcome-email.marka-legal-team') }}
                                            </p>
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                ...
                                                                                <a href="{{ route('keyword.create') }}"
                                                                                    ...
                                                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #4650dd; border-bottom: 8px solid #4650dd; border-left: 18px solid #4650dd; border-right: 18px solid #4650dd; border-top: 8px solid #4650dd;">{{ __('theme/emails/welcome-email.add-keyword') }}</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                    ...
                                    <tr>
                                        <td class="content-cell" align="center"
                                            ...
                                            <p
                                                ...
                                                © {{ date('Y') }} {{ env('APP_NAME') }}.
                                                {{ __('theme/emails/welcome-email.all-rights-reserved') }}.</p>
                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">
                                                {{ __('theme/emails/welcome-email.address') }}
                                            </p>
                                        </td>
                                    </tr>
                                </table>
