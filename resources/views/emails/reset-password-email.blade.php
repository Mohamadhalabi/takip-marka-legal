                                    ...
                                    <tr>
                                        <td class="content-cell"
                                            ...
                                            <h1
                                                ...
                                                {{ __('theme/emails/reset-password-email.password-reset') }}</h1>
                                            <p
                                                ...
                                                {{ __('theme/emails/reset-password-email.click-the-button-below') }}</p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/reset-password-email.this-password-reset-link-will-expire-in') }}
                                                {{ Lang::get(':count', ['count' => config('auth.passwords.' . config('auth.defaults.passwords') . '.expire')]) }}
                                                {{ __('theme/emails/reset-password-email.minute') }}
                                                {{ __('theme/emails/reset-password-email.will-end-in') }}
                                            </p>
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                ...
                                                                                <a href="{{ $url }}"
                                                                                    ...
                                                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #4650dd; border-bottom: 8px solid #4650dd; border-left: 18px solid #4650dd; border-right: 18px solid #4650dd; border-top: 8px solid #4650dd;">Şifreyi
                                                                                    yenile</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                            ...
                                            <table class="subcopy" width="100%" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <p
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                            {{ __('theme/emails/reset-password-email.you-are-receiving-this-because-we-have-received-a-password-reset-request-for-your-account') }}
                                                        </p>

                                                        <p
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                            {{ __('theme/emails/reset-password-email.if-you-have-not-requested-a-password-reset-you-do-not-need-to-take-any-further-action') }}
                                                        </p>
