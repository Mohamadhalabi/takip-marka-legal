                                    ...
                                    <tr>
                                        <td class="content-cell"
                                            ...
                                            <h1
                                                ...
                                                {{ __('theme/emails/report-email.new-report') }}</h1>
                                            <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;"{{ __('theme/emails/report-email.mr') }}
                                                {{ $user->name }}</p>
                                            ...
                                            <p
                                                ...
                                                {{ __('theme/emails/report-email.new-trademark') }}
                                                {{ Carbon\Carbon::parse($date)->format('d-m-Y') }}
                                                {{ __('theme/emails/report-email.bulletins-reviewed') }}</p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                @foreach ($json as $js)
                                                    * {{ substr($js['title'], 0, 3) }}
                                                    {{ __('theme/emails/report-email.official-trademark-bulletin') }} <br>
                                                @endforeach
                                            </p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/report-email.report-access') }}</p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/report-email.thanks-message') }}</p>

                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                {{ __('theme/emails/report-email.marka-legal-team') }}</p>
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td
                                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                                <a href="https://takip.marka.legal/en/dashboard/report/{{ $report->id }}"
                                                                                    class="button button-primary"
                                                                                    target="_blank" rel="noopener"
                                                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #4650dd; border-bottom: 8px solid #4650dd; border-left: 18px solid #4650dd; border-right: 18px solid #4650dd; border-top: 8px solid #4650dd;">{{ __('theme/emails/report-email.show-report') }}</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
